...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="dashboard.php?page=profile" class="logo"><b>GOLDSALE<span>FATAFAT</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="dashboard.php?page=profile"><img src="" width="150"></a></p>
